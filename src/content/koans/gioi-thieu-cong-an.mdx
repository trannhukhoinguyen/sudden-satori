  ...
  <div className="container">
      <details>
          ...
          <p>
              ...
              Khi trắc nghiệm sự chứng ngộ của môn đệ trong lúc tu tập công án cấp cao, các vị Thiền sư thường đặt ra những câu hỏi đặc biệt, hỏi ngang dọc, hỏi về sự liên hệ của công án (thiền sinh đang quán) với giáo lý Đại thừa, đặt những câu hỏi mới, khác biệt (tạp tắc 雜則, ja. zassoku) song song với công án gốc (bản tắc 本則, ja. honsoku) và vì vậy, công án chính được sáng rọi cùng tận bằng nhiều cách khác nhau.

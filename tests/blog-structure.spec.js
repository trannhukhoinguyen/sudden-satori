...
test.describe('Blog Structure', () => {
  test('no markdown files should exist in src/pages/blogs/', async () => {
    // Check that no .md files exist in the pages/blogs directory
    const pagesDir = join(process.cwd(), 'src/pages/blogs');
    let files = [];
